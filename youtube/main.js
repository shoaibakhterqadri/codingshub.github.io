  ...
  if(YouTube.value!=""){
    switch (format.value){
      ...
      case "mp3":
         ...
         document.querySelector('.result2').innerHTML = `<iframe style=" border-radius:15px; width:100%;height:45px;border:hidden;overflow:hidden; bore" scrolling="no" src="${url2}"></iframe>`;
         preview();
      break;
      case "m4a":
         hidden.classList.add('active');
